...
plus(V1, V2, I3) :- var(V1),     var(V2),     integer(I3), !, integer_sequence(0, infinity, 1, V1), V2 is I3-V1.
...
plus([V1, From], V2,         I3) :- var(V1),     var(V2),     integer(I3), !, integer_sequence(From, infinity, 1, V1), V2 is I3-V1.
...
plus([V1, From, To], V2,             I3) :- var(V1),     var(V2),     integer(I3), !, integer_sequence(From, To, 1, V1), V2 is I3-V1.
...
plus(V1, [V2, From, To], I3)             :- var(V1),     var(V2),     integer(I3), !, integer_sequence(From, To, 1, V2), V1 is I3-V2.
